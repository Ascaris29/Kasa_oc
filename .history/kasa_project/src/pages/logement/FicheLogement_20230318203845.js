...
export default function FicheLogement(){
    ...
    useEffect(() => {
        async function getDataById(){
                 const response = await axios.get("/datas.json");
    ...
    return (
             data && (
                    ...
                    <div className={`${style.fichelogementBlocs} d-flex`}>
                            <CardDescription classNameCard={`${style.fichelogementCard}`} title="Description" text={data.description} key={data.description{i}}/>
