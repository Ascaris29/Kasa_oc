    ...
    return (
             data && (
                    ...
                    <div className={`${style.fichelogementBlocs} d-flex`}>
                            <CardDescription classNameCard={`${style.fichelogementCard}`} title="Description" text={data.description} key={data.description}/>
                            { data.equipments.map((i) => ( <CardDescription classNameCard={`${style.fichelogementCard}`} title="Équipements"/> text={data.equipments.map((i) => (<p>{i}</p>))} key={data.equipments}))}
                            <CardDescription classNameCard={`${style.fichelogementCard}`} title="Équipements" text={data.equipments.map((i) => (<p>{i}</p>))} key={data.equipments}/> 
                    </div>
                </div>
                )
    )
