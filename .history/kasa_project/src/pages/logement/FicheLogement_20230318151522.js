        ...
        <>
            <div className={`${style.fichelogement} flex-fill d-flex flex-column`}>
                ...
                <div className={`${style.fichelogementBlocs} d-flex`}>
                        <CardDescription key={donnée.des}classNameBloc={`${style.fichelogementCard}`} title="Description" text={donnée.description}/>
                        <CardDescription classNameBloc={`${style.fichelogementCard}`} title="Équipements" text={ arrayEquipments.map(i => <br>{`- ${i}`}</br>)} />
                </div>
            </div>
        </>
