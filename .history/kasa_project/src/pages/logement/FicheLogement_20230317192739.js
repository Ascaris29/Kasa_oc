        ...
        <>
            <div className={`${style.fichelogement} flex-fill d-flex flex-column`}>
                ...
                <div className={`${style.fichelogementBlocs} d-flex`}>
                        <CardDescription classNameBloc={`${style.fichelogementCard}`} title="Description" text={donnée.description} classNameDesc="" />
                        <CardDescription classNameBloc={`${style.fichelogementCard}`} title="Équipements" text={donnée.equipments} classNameDesc={`${style.fichelogementList}`}/>
                </div>
            </div>
        </>
