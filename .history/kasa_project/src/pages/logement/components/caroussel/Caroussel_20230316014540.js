...
export default function Caroussel(){
    ...
    return (
        <div>
            ...
            <button onClick={handleClickCarousselPrev}> avant </button><i class="fa-solid fa-chevron-left" onClick={handleClickCarousselPrev}></i>
            <button onClick={handleClickCarousselAfter}> après </button>  <i class="fa-solid fa-chevron-right" onClick={handleClickCarousselAfter}></i> 
        </div>
    )
