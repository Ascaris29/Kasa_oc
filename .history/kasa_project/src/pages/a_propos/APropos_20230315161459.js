...
export default function APropos(){
    return (
            <div className={`${style.apropos} p-30`}>
                ...
                <CardDescription title="Service" text="La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoires ou de perturbation du voisinage entrainera une exclusion de notre plateforme."/>
