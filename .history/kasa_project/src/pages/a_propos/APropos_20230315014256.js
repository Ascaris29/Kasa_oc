            ...
            <div className={`${style.apropos} p-30`}>
                ...
                <div className={`${style.aproposContent} d-flex flex-column`}>
                    ...
                    <div className={`${style.aproposCard}`}>
                        ...
                        <div name={clickables.name} className={isHidden ? `${style.aproposCardHidden}` : `${style.aproposCardShow}`}>La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoires ou de perturbation du voisinage entrainera une exclusion de notre plateforme.</div>
                    </div>
                    <div className={`${style.aproposCard}`}>
