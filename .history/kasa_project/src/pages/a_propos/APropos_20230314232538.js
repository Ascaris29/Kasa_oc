            ...
            <div className={`${style.apropos} p-30`}>
                ...
                <div className={`${style.aproposContent} d-flex flex-column`}>
                    ...
                    <div className={`${style.aproposCard}`}>
                        <div className={`${style.aproposCardTitle} d-flex justify`}>Respect<i class="fa-solid fa-chevron-up"></i></div>
                    ...
                    <div className={`${style.aproposCard}`}>
                        <div className={`${style.aproposCardTitle}`}>Service<i class="fa-solid fa-chevron-up"></i></div>
                    ...
                    <div className={`${style.aproposCard} d-flex flex-column`}>
                        <div className={`${style.aproposCardTitle} d-flex`}>Sécurité<i class="fa-solid fa-chevron-up"></i></div>
