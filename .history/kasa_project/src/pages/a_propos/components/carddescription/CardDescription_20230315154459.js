...
export default function CardDescription(title, texte){
    return (
        ...
        <div className={`${style.aproposCard}`}>
            <h3 className={`${style.aproposCardTitle} d-flex justify-between`}>title <i className={`${style.aproposIcon} fa-solid fa-chevron-up`} onClick={handleShowCardHidden}></i></h3>
