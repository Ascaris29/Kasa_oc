            ...
            <div className={`${style.apropos} p-30`}>
                ...
                <div className="aproposContent">
                    <div className={aproposCard}>
                        <div className="aproposCardTitle">Fiabilité</div>
                    ...
                    <div className="aproposCard">
                        <div className="aproposCardTitle">Respect</div>
                    ...
                    <div className="aproposCard">
                        <div className="aproposCardTitle">Service</div>
