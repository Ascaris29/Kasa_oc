        ...
        <>
            <div className={`${style.fichelogement} flex-fill d-flex flex-column`}>
                ...
                <div className={`${style.fichelogementBlocs} d-flex`}>
                        ...
                        <CardDescription classNameCard={`${style.fichelogementCard}`} classNameDescription={`${style.fichelogementList}`}title="Équipements" text={arrayEquipments.map(i => return (<p></p>)`- ${i}`)} />
                </div>
            </div>
        </>
