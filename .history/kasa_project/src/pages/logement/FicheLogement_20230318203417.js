    ...
    return (
             data && (
                    ...
                    <div className={`${style.fichelogementBlocs} d-flex`}>
                            <CardDescription classNameCard={`${style.fichelogementCard}`} title="Description" text={data.description} key={data.des}/>
                            <CardDescription classNameCard={`${style.fichelogementCard}`} title="Équipements" text={data.equipments.map((i) => (<p>{i}</p>))}/> 
                    </div>
                </div>
                )
    )
