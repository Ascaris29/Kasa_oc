...
export default function Homepage(){
    ...
    async function FetchApi(){
        ...
        try{
            const response = await fetch("https://cors-anywhere.herokuapp.com/ s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/Front-End+V2/P9+React+1/logements.json", { 
                method : "GET",
                headers : {
