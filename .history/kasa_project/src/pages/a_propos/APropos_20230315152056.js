    ...
    return (
            <div className={`${style.apropos} p-30`}>
                ...
                <div className={`${style.aproposContent} d-flex flex-column`}>
                    ...
                    <div className={`${style.aproposCard} d-flex flex-column`}>
                        <h3 className={`${style.aproposCardTitle} d-flex justify-between`}>Sécurité<i className={`${style.aproposIcon} fa-solid fa-chevron-up`} onClick={handleShowCardHidden}></i></div>
