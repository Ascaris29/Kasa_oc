    ...
    return (
            <div className={`${style.apropos} p-30`}>
                ...
                <div className="aproposContent">
                    ...
                    <div className="aproposCard">
                        <div className="aproposCardShow">La sécurité est la propriété de Kasa. Aussi bien pour nos hôtes que pour les voyageurs, chaque logement correspond aux critères de sécurité établis par nos services. En laissant une note aussi bien à l'hôte qu'au locataire, cela permet à nos équipes de vérifier que les standars sont bien respectés. Nous organisons </div>
