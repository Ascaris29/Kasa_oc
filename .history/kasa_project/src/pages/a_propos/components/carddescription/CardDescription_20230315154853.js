...
export default function CardDescription(title, texte){
    return (
        ...
        <div className={`${style.cardDescriptionCard}`}>
            <h3 className={`${style.cardDescriptionTitle} d-flex justify-between`}>Service<i className={`${style.acardDescriptionIcon} fa-solid fa-chevron-up`} onClick={handleShowCardHidden}></i></h3>
