            ...
            <div className={`${style.apropos} p-30`}>
                ...
                <div className="aproposContent">
                    ...
                    <div className="aproposCard">
                        ...
                        <div className="aproposCardHidden">La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoires ou de perturbation du voisinage entrainera </div>
                    </div>
                    <div className="aproposCard">
